...
public class WindowModel_noCap {
	...
	public WindowModel_noCap(int _windowSize, int _hiddenSize, double _lr, double _reg) {
	...
	public void initWeights() {
		...
		W = SimpleMatrix.random(hiddenSize, wordSize * windowSize, -wEInit,
				wEInit, new Random());
